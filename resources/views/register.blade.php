...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form id="registrationForm" action="{{ route('verify.two.factor.register.initiate') }}" method="POST">
            ...
            <input hidden id="role" name="role" value="user">
        ...
        <!-- Verification Form -->
        <form id="verificationForm" action="{{ route('verify.two.factor.register.verify') }}" method="POST" style="display: none;">
            @csrf
            <div class="form-group mb-3">
    ...
    $(document).ready(function () {
        ...
        $('#verificationForm').on('submit',function(e){
            ...
            $('#resend-button-container').on('click', function () {
                spinner.show();
            $.ajax({
                url: '{{ route('verify.two.factor.resend') }}',
                method: 'GET',
                success: function (response) {
                    spinner.hide();
                    if (response.success) {
